...
ggsave(here::here("output/data_analysis_ghana/plot_population_pyramid.png"), plot_pyramid,
...
# Save the plot at 300 dpi
ggsave(here::here("output/data_analysis_ghana/plot_education_stacked.png"), plot_education_stacked,
...
# Save the plot at 300 dpi
ggsave(here::here("output/data_analysis_ghana/plot_employment_stacked.png"), plot_employment_stacked,
       width = 10, height = 3, dpi = 300)
```
...
# Save the plot at 300 dpi
ggsave(here::here("output/data_analysis_ghana/plot_programming_skills.png"), plot_programming,
       width = 8, height = 6, dpi = 300)
```
...
# Save the plot at 300 dpi
ggsave(here::here("output/data_analysis_ghana/plot_llm_platforms.png"), plot_llm_platforms,
       width = 8, height = 6, dpi = 300)
```
