...
kobo_clean <- raw_data |>
  mutate(
    github_username = case_when(
      ...
      github_username == "https://github.com/adesijivictoria" ~
        "adesijivictoria",
      ...
      github_username == "AnalystKemi (https://github.com/AnalystKemi)" ~
        "AnalystKemi",
...
write_csv(
  kobo_clean,
  file = here::here("output/mentorship_list.csv")
)
