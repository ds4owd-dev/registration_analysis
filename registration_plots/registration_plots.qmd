...
ggsave(here::here("registration_plots/output/countries_plot.jpg"), plot = countries_plot, width = 8, height = 4, dpi = 300)
```
...
ggsave(here::here("registration_plots/output/plot_pyramid.jpg"), plot = plot_pyramid, width = 8, height = 6, dpi = 300)
```
